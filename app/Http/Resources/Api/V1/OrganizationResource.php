...
class OrganizationResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        ...
        return [
            ...
            'pricing_plan' => $this->pricingGroup ? [
                'name' => $this->pricingGroup->name,
                'price_minor' => $this->pricingGroup->price_minor,
                'currency' => $this->pricingGroup->currency,
                'billing_interval' => $this->pricingGroup->billing_interval,
            ] : null,
